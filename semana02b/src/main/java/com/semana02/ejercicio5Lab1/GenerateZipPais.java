...
public class GenerateZipPais {
    ...
    public void procesar() {
        ...
        try {
            fileWriter = new FileWriter("D:/CLASES ANALIA/VI CICLO/01-DESARROLLO DE SERVICIOS WEB/FILE/Pais.json");
        ...
        try {
            fileWriterXML = new FileWriter("D:/CLASES ANALIA/VI CICLO/01-DESARROLLO DE SERVICIOS WEB/FILE/Pais.xml");
        ...
        try {
             ZipOutputStream zipOut = new ZipOutputStream(new FileOutputStream("D:/CLASES ANALIA/VI CICLO/01-DESARROLLO DE SERVICIOS WEB/FILE/paisComprimido.zip"));
