package com.semana02.ejercicio03xl;
...
public class CreateExcel {
    public static void main(String[] args) {
        ...
        //imprimir en consola los arraList
        System.out.println(productos);
         ...
         try {
             FileOutputStream fileOut = new FileOutputStream("D:/CLASES ANALIA/VI CICLO/01-DESARROLLO DE SERVICIOS WEB/FILE/Productos_FiestasG1.xlsx");
