...
public class GenerateZipCatalogo {
    ...
    public void procesar() {
        ...
        try {
            fileWriter = new FileWriter("D:/CLASES ANALIA/VI CICLO/01-DESARROLLO DE SERVICIOS WEB/FILE/Catalogo.json");
        ...
        try {
            fileWriterXML = new FileWriter("D:/CLASES ANALIA/VI CICLO/01-DESARROLLO DE SERVICIOS WEB/FILE/Catalogo.xml");
        ...
        try {
             ZipOutputStream zipOut = new ZipOutputStream(new FileOutputStream("D:/CLASES ANALIA/VI CICLO/01-DESARROLLO DE SERVICIOS WEB/FILE/catalogosComprimido.zip"));
